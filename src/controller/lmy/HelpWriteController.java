...
public class HelpWriteController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, 
		...
		String title,content,category,normal_or_host,id,notice_no;
		//3]요청분석- 입력처리 요청
		//4]모델호출 및 결과값 받기
...
*/			//이동 방법1 - 자스의 history.back()으로 입력폼으로 이동.
		...
		/*	if(mr == null) {
			...
			req.setAttribute("notice_no",req.getParameter("notice_no"));
			req.setAttribute("normal_or_host",req.getParameter("normal_or_host"));
